...
<%	
	...
	MultipartRequest mr = new MultipartRequest(request, // 내부적으로 필요한 request 객체 전달
		realPath,						// 업로드할 파일 저장할 경로
		1024*1023*100, 					// 최대 업로드 사이즈 제한 
		"utf-8", 						// 한글 파일명 안깨지게
		new DefaultFileRenamePolicy()
		);	// 동일한 파일이 존재하면 자동으로 파일을 rename해서 저장
			
	/*
		위의 MultipartRequest 객체가 예외가 발생하지 않고 잘 생성되었다면 파일 업로드 성공
	...
	*/
	...
	// 4. 추가로 원본 파일명 저장된 파일명 파일사이즈도 얻어와서 FileDto 객체에 담아서
